...
public class KeyValueMessage extends Message {
	 ...
	 */
	public KeyValueMessage addColumn(String colName, boolean isMandatory, Class<? extends Serializable> type) throws Exception {
	 ...
	 * @return 현재 객체(fluent coding 용)
	 */
	public KeyValueMessage addColumn(String colName, Class<? extends Serializable> type) throws Exception {
	 ...
	 * @return 현재 객체(fluent coding 용)
	 */
	public KeyValueMessage set(String colName, Serializable data) throws Exception {
